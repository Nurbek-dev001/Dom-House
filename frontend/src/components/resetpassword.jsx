    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute bottom-20 left-20 w-24 h-24 bg-teal-200 rounded-full opacity-25"
        />
      </div>
      ...
      >
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-teal-400/10 to-cyan-400/10 rounded-full translate-y-12 -translate-x-12" />
          ...
          <motion.div variants={inputVariants} className="text-center mb-8 relative">
            <Link to="/" className="inline-block mb-6 group">
              ...
              >
                ...
                <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-teal-600 bg-clip-text text-transparent">
                  DomHouse
                </h2>
              </motion.div>
            </Link>
