...
const socialLinks = [
  ...
  // GitHub link removed per design request
];
...
const contactInfo = [
  { 
    icon: MapPin, 
    text: 'Kazakh Eli Avenue 42, Almaty, KZ 050010',
    href: 'https://maps.google.com/?q=Almaty,Kazakhstan' 
  },
  { 
    icon: Phone, 
    text: '+7 (727) 290-58-01',
    href: 'tel:+77272905801'
  },
  { 
    icon: Mail, 
    text: 'support@domhouse.com',
    href: 'mailto:support@domhouse.com' 
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <motion.p 
              ...
              transition={{ duration: 0.5 }}
            >
              <span>© {new Date().getFullYear()} DomHouse. All Rights Reserved.</span>
            </motion.p>
