...
const TestimonialCard = ({ testimonial, index, direction }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 via-transparent to-teal-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 flex items-center mb-2">
              <span className="inline-block w-2 h-2 rounded-full bg-gradient-to-r from-blue-500 to-teal-500 mr-2 animate-pulse" />
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-gradient-to-r from-blue-600/5 to-teal-600/5 rounded-3xl pointer-events-none"
      />
    </motion.div>
  );
};
...
const Testimonials = () => {
  ...
  const stats = [
    ...
    { icon: Award, value: "50+", label: "Awards Won", color: "from-teal-500 to-cyan-500" },
  ...
  return (
    <section className="relative py-32 bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-teal-400/10 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-blue-100/20 to-teal-100/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-teal-600 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 shadow-lg"
          >
          ...
          <motion.h2 
            ...
            className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-teal-900 bg-clip-text text-transparent mb-6"
          >
            What Our Clients
          ...
          <motion.div 
            ...
            className="w-32 h-1.5 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-8 rounded-full"
          />
          ...
          >
            Discover why thousands of homeowners trust DomHouse to find their perfect property. 
                ...
                <div className="flex items-center space-x-4">
                  <div className="relative group/avatar">
                    <img
                      ...
                      className="w-16 h-16 rounded-full object-cover border-3 border-white shadow-lg group-hover/avatar:shadow-xl transition-shadow duration-300"
                    />
                    <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-400/20 to-teal-400/20 opacity-0 group-hover/avatar:opacity-100 transition-opacity duration-300" />
        ...
        >
          ...
          >
            <a 
              href="/contact" 
              className="group inline-flex items-center bg-gradient-to-r from-blue-600 via-blue-700 to-teal-600 text-white py-4 px-8 rounded-2xl font-semibold text-lg hover:from-blue-700 hover:to-teal-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              style={{ boxShadow: "0 10px 30px rgba(59, 130, 246, 0.3)" }}
            >
              <Heart className="mr-3 w-5 h-5 text-teal-300 group-hover:text-teal-200 transition-colors duration-200" />
