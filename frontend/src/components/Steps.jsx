  ...
  return (
    ...
    >
      ...
      >
        {/* Animated background */}
        <motion.div 
          className="absolute inset-0 bg-gradient-to-r from-blue-600 via-indigo-600 to-teal-600 opacity-0 
    ...
    <section className="relative py-32 bg-gradient-to-b from-white via-blue-50/30 to-indigo-50/30 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div 
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
            w-96 h-96 bg-teal-200/10 rounded-full blur-3xl"
          animate={{ rotate: 360 }}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Decorative line */}
          <motion.div 
            className="w-32 h-1.5 bg-gradient-to-r from-blue-500 via-indigo-500 to-teal-500 
        ...
        >
          ...
          <div className="hidden lg:block absolute top-12 left-[16%] right-[16%] h-1 bg-gray-100 rounded-full">
            <motion.div 
              className="h-full bg-gradient-to-r from-blue-500 via-indigo-500 to-teal-500 rounded-full"
              initial={{ width: "0%" }}
        ...
        >
          ...
          <motion.a
            ...
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r 
              from-blue-600 via-indigo-600 to-teal-600 text-white font-semibold rounded-2xl 
        ...
        >
          <div className="relative bg-gradient-to-br from-white/80 to-blue-50/80 backdrop-blur-sm 
            ...
            <div className="absolute top-0 left-0 w-full h-full">
              ...
              <div className="absolute top-1/2 right-8 w-6 h-6 bg-teal-200/30 rounded-full"></div>
            </div>
